...
document.addEventListener("DOMContentLoaded", function(){ 
    ...
    //function to toggle the completion status of an action
    async function toggleActionCompletion(actionId) {
        try{
            await fetch(`../php/update_task_action.php?action_id=${actionId}`, { method: "POST" });
            fetchTasks();
        } 
        catch(error){
